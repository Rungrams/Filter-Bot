...
if START_IMG is None:
    img = "https://telegra.ph/file/bd38f74a32f02d5b92e70.jpg"
else:
  img = START_IMG    
...
def send_start(bot, update):
    ...
    keyboard += [[InlineKeyboardButton(text=devloper",url="https://t.me/telegram),InlineKeyboardButton(text="repo",url="t.me/whatapp")]]
...
def get_help(bot: Bot, update: Update):
    ...
    if chat.type != chat.PRIVATE:
        ...
        update.effective_message.reply_text("Contact me in PM to get the list of possible commands.",
                                            reply_markup=InlineKeyboardMarkup(
                                                [[InlineKeyboardButton(text="⚙️Help",url="t.me/{}?start=help".format(bot.username))],  
                                                [InlineKeyboardButton(text="DEVLOAPER👩‍💻",url="https://t.me/rungram")]]))
        return
